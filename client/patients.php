  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <!-- FORM -->
		<form action="clincludes/addpatient.inc.php" method="POST">
...
<!-- table header -->
					...
					<h2> Patients </h2>
                        <button type="button" class="btn btn btn-primary float-right" data-toggle="modal" data-target="#addsumodal"> <i class="fas fa-edit"></i> Add Patient </button>
                    </div>
<br>
  ...
  while($row = mysqli_fetch_assoc($result)) {
	...
	?>
									...
									<tr>
										...
										<td> <button class="btn btn-warning" data-toggle="modal" data-target="#editsumodal<?php echo $row['patient_id']?>"> <i class="fas fa-pen"></i> Edit </button> </td>
										<td> <a type="button" class="btn btn-danger" href="clincludes/delpatient.inc.php?Del=<?php echo $id ?> "> <i class="fas fa-trash"></i> Delete </a> </td>
										<td> <a type="button" class="btn btn-success" href=" "> <i class="fas fa-plus"></i> Add as User </a> </td>
									</tr>

<!-- Modal for Edit Button -->
<div class="modal fade" id="editsumodal<?php echo $row['patient_id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	<form action="clincludes/editspatient.inc.php" method="POST">
      <div class="modal-header">
